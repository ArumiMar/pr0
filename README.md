...
Se tienen 3 tarea y además delegando el tiempo muerto del microprocesador a la tarea Idle:
1. TaskFastBlink (prioridad 1): controla un parpadeo rápido del LED externo (100 ms encendido / 100 ms apagado)
3. TaskSlowBlink (prioridad 1): controla un parpadeo lento del LED externo (500 ms encendido / 500 ms apagado)
5. TaskManager (Prioridad 2): opera en ciclos continuos de 15 segundos, divididos en tres fases de 5 segundos cada una:
